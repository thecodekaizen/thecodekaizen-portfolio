    ...
    <div className="min-h-screen pt-20 pb-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="py-8 sm:py-content">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-light text-text-primary mb-12 sm:mb-16 lowercase leading-tight">
            about
          </h1>
          
          {/* Bio */}
          <div className="max-w-2xl mb-8 sm:mb-section">
            <p className="text-lg sm:text-xl md:text-2xl text-text-secondary font-light leading-relaxed mb-6 sm:mb-8">
        ...
        <div className="py-8 sm:py-section">
          <h2 className="text-xl sm:text-2xl font-medium text-text-primary mb-8 sm:mb-12 lowercase">
            timeline
          </h2>
          ...
          <div className="space-y-6 sm:space-y-8">
            {timeline.map((item, index) => (
              <div key={index} className="flex items-center gap-4 sm:gap-8">
                <div className="text-base sm:text-lg font-medium text-accent min-w-[60px] sm:min-w-[80px] shrink-0">
                  {item.year}
                </div>
                <div className="w-2 h-2 bg-accent rounded-full shrink-0"></div>
                <div className="text-base sm:text-lg text-text-secondary lowercase">
                  {item.description}
                </div>
              </div>
            ))}
